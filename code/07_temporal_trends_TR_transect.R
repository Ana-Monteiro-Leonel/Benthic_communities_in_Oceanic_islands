...
# Outputs:
#   - results/figures/Figure_7_temporal_trends_TR.png
#   - results/figures/Figure_7_temporal_trends_TR.tiff
...
if(length(results) > 0) {
  ...
  # Save outputs
  ggsave("results/figures/Figure_7_temporal_trends_TR.png", combined_plot, 
         width = 10, height = 8, dpi = 600)
  ggsave("results/figures/Figure_7_temporal_trends_TR.tiff", combined_plot, 
